        ...
        <div class="fr-header__body-row">
          ...
          <div class="fr-header__tools">
            <div class="fr-header__tools-links">
              <ul class="fr-btns-group" v-if="me">
                <li>
                    <a :href="`/en/users/${me.slug}/`" class="fr-btn fr-icon-svg fr-icon--sm fr-grid-row">
                      <!-- <img src="/api/1/avatars/65cb36cd69808422020f9b04/24" width="24" height="24" loading="lazy" alt="" class="fr-mr-1w rounded-circle"> -->
                      {{ me.first_name }} {{ me.last_name }}
                    </a>
                </li>
                <li>
                    <a href="/en/admin/" class="fr-btn fr-icon-svg fr-icon--sm">
